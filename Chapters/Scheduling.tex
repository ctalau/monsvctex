...
This step depends slightly on the compressed size of the histograms and takes 0.1 - 0.2 ms. We used as a model for the duration of this step: 90 us + size $\times$ 0.0066 us.
