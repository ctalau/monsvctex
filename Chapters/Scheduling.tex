...
We can notice that for the expected case with 5-10 nice periods we need only 2.5 more slots than the optimum which is negligible compared to 50-100 slots per second. Even in the extreme case of 10-20 nice periods and 5-10 non-nice we waste at most 20\% of the slots.
...
\caption{Traffic shape comparison (20ms bins).}
...
\caption{Traffic shape comparison during a high-load period (1ms bins).}
