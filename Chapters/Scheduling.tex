...
The second experiment aims to study how the global scheduling algorithm behaves over longer periods. We are interested in the behaviour for the case in which some of the slots are too short for the histograms assigned to them.
