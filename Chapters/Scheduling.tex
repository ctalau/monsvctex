...
The number of histograms that we need to publish per second is $\frac {5130}{120} + {8}{10} = 43.55$, so we configured 50 slots per second. The initial delay bound was chosen to be 75\% of the slot duration. We also ran experiments with 60 and 75 slots per second to analyze how the system behaves if more histograms will be added in the future.
