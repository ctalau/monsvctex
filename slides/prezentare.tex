...
\begin{frame}
	...
	\begin{tikzpicture}
        ...
        \node [right of=5s,node distance=2.25cm,text width=3cm] 
        	{\alt<15>
        		{\tiny \{.75\}}
        		{\alt<16->
        			{\tiny \{.75, 1.75, $\ldots$\}}
        ...
        \node [right of=2s,node distance=2.25cm,text width=3cm] 
        	{\alt<17>
        		{\tiny \{0, .25, .5\}}
        		{\alt<18>
        ...
        \uncover<21- >{\node [above of=2l1,node distance=.25cm] {\tiny 0};}
        \uncover<22- >{\node [above of=2l2,node distance=.25cm] {\tiny .25};}       
        \uncover<23- >{\node [above of=2l3,node distance=.25cm] {\tiny .5};}
        ...
        \uncover<25- >{\node [above of=2l4,node distance=.25cm] {\tiny 1};}
        \uncover<26- >{\node [above of=2l5,node distance=.25cm] {\tiny 1.25};}
